        ...
        <div className="flex flex-row gap-x-8">
          ...
          <div className="w-[30rem] flex flex-col">
            ...
            <p className="text-link font-semibold">
              ...
              Curabitur dapibus molestie ultrices.
              <span className={`max-h-0 overflow-hidden inline-block ${collapse ? " max-h-full pb-2" : ""}`}>
                Nullam odio ipsum, auctor quis gravida ut, cursus non nibh.
                Nullam scelerisque nisl fermentum venenatis porta. Morbi iaculis
                a dui quis malesuada. Curabitur euismod bibendum ipsum, quis
                viverra nisi elementum in. Proin tempus gravida elit, vitae
                varius eros molestie at. Quisque lacinia enim lorem, quis rutrum
                felis ullamcorper eu. Suspendisse laoreet nunc urna, ac laoreet
                dolor accumsan ut.
              </span>
              <button onClick={() => setCollapse((prev) => !prev)}>{collapse ? <span>daha az göster</span> : <span>...daha fazla göster</span>}</button>
            </p>
          </div>
        </div>
      </div>
